...
`local_training_data_generator.py`: Generates data for local training (no Split Learning or Reference Set here).
...
`local_test_data_generatror.py`: Responsible for the creation of test datasets
