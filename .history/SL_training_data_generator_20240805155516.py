...
for part in range(3,4):
    ...
    indicesA = shuffled_indices[:2000].tolist()
    indicesB = shuffled_indices[2000:4000].tolist()
    ...
    for nrows in total_rows:
        for refrows in total_refrows:
            ...
            if isinstance(metric, str):
                ...
                csv_name = "round3_n"+str(nrows)+"_ref"+str(refrows)+"_"+str(part)+".csv"
            ...
            trainA.to_csv('/media/mike/corsair/correct_data/new_dataset/trainingA_'+csv_name, index=False, header=None, chunksize=50000)
            end_time = time.time()
