...
for part in range(1,2):
    for test_rows in total_test_rows:
        ...
        filename = '/media/mike/corsair/correct_data/new_dataset/only_tests/no_ref_tests/local_test_n'+str(test_rows)+'_'+str(part)+'.csv'
        filename = 'Data/test_samples/part'+str(part)+'_'+metric+'_n'+str(test_rows)+'.csv'
        print(filename)
