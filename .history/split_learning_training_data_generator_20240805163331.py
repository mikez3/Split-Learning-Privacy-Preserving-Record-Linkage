    ...
    for nrows in total_rows:
        for refrows in total_refrows:
            ...
            if isinstance(metric, str):
                csv_name = 'part'+str(part)+'_'+metric+"_n"+str(nrows)+"_reference_set"+str(refrows)+".csv"
            elif callable(metric):
                csv_name = 'part'+str(part)+'_'+str(metric.__name__)+"_n"+str(nrows)+"_reference_set"+str(refrows)+".csv"
